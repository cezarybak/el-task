...
export type SearchMostTop10StarQueryVariables = Exact<{
  queryString: Scalars['String'];
}>;


export type SearchMostTop10StarQuery = { search: { repositoryCount: number, edges?: Array<{ node?: { id: string, login: string, name?: string | null, avatarUrl: any, followers: { totalCount: number }, following: { totalCount: number }, starredRepositories: { totalCount: number } } | {} | null } | null> | null } };


export const SearchMostTop10StarDocument = gql`
...
/**
 * __useSearchMostTop10StarQuery__
 *
 * To run a query within a React component, call `useSearchMostTop10StarQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchMostTop10StarQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchMostTop10StarQuery({
 *   variables: {
 *      queryString: // value for 'queryString'
 *   },
 * });
 */
export function useSearchMostTop10StarQuery(baseOptions: Apollo.QueryHookOptions<SearchMostTop10StarQuery, SearchMostTop10StarQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SearchMostTop10StarQuery, SearchMostTop10StarQueryVariables>(SearchMostTop10StarDocument, options);
      }
export function useSearchMostTop10StarLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchMostTop10StarQuery, SearchMostTop10StarQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SearchMostTop10StarQuery, SearchMostTop10StarQueryVariables>(SearchMostTop10StarDocument, options);
        }
export type SearchMostTop10StarQueryHookResult = ReturnType<typeof useSearchMostTop10StarQuery>;
export type SearchMostTop10StarLazyQueryHookResult = ReturnType<typeof useSearchMostTop10StarLazyQuery>;
export type SearchMostTop10StarQueryResult = Apollo.QueryResult<SearchMostTop10StarQuery, SearchMostTop10StarQueryVariables>;